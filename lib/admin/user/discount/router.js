...
router.get('/:user_id/view', rights.corp_manager, discount.view);
router.get('/:user_id/edit', rights.corp_manager, discount.edit);
router.post('/save', rights.corp_manager, discount.save);
